...
Server MAY require payment for file storage. In that case, the server MUST return a **402 Payment Required** status code and 'Www-Authenticate' header with the macaroon and the payment request. See [Payment required](02.md#payment-required)
