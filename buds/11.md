...
Using the `Authorization` HTTP header, the authorization token SHOULD be encoded as Base64 and using the `Nostr` authorization scheme. Servers MAY also support URL-safe Base64 and padded or unpadded encodings.
